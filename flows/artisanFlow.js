...
async function handleArtisanFlow(profile, payload, isButton) {
  ...
  // 🚨 THE FIX: 'isButton' is REMOVED. Now they can literally type "YES" or "ACCEPT" and it works!
  ...
  // 🚨 THE FIX: 'isButton' is REMOVED here too.
  ...
  // --- 3. ARRIVAL CHECK-IN ---
  // (We leave isButton here because this is a standard menu button generated by the bot, not Meta)
